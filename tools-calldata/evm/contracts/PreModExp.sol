...
contract PreModExp {
    ...
    function modexp_1() public {
        ...
        assembly {
            ...
            // assign base, exponent, modulus
            mstore(add(memPtr, 0x60), 0xffff)
            mstore(add(memPtr, 0x80), 0xffff)
            mstore(add(memPtr, 0xa0), 0xea5)

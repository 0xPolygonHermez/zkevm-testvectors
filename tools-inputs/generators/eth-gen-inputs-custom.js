            ...
            if (txsLength === 0) {
                ...
                for (let y = 0; y < txsLength; y++) {
                    ...
                    try {
                        ...
                        //                 console.log(Scalar.e(newLeaf.balance).toString());
                        //                 console.log(Scalar.e(infoExpect.balance).toString());
                        //                 // expect(Scalar.e(newLeaf.balance).toString()).to.be.equal(Scalar.e(infoExpect.balance).toString());
                        //             }

                        //             if (infoExpect.nonce) {
                        //                 console.log(Scalar.e(newLeaf.nonce).toString());
                        //                 console.log(Scalar.e(infoExpect.nonce).toString());
                        ...
                        //                             console.log(elem);
                        //                             console.log(Scalar.e(infoExpect.storage[elem]));
                        //                             console.log(Scalar.e(storage[`0x${elem.slice(2).padStart(64, '0')}`]));
                        ...
                        if (listOOC.filter((elem) => writeOutputName.includes(elem.fileName)) > 0) {

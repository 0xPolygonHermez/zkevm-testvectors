...
function main() {
    ...
    for(let i = 0; i < NUM_TESTS; i++) {
        ...
        const objTest = {
            "id": i,
            "description": `precompiled rip7212 test ${i} bytes`,
    ...
    fs.writeFileSync("./generate-test-vectors/gen-pre-rip7212-160-random.json", JSON.stringify(genTests, null, 2))
}
